  ...
  return (
    <footer className="bg-black text-white text-sm px-4 py-6">
      <div className="max-w-6xl mx-auto flex justify-between items-center flex-wrap">
        ...
        <a href="https://www.facebook.com/daquv/" target="_blank" rel="noopener noreferrer">
          <img src="/icons/facebook.png" alt="Facebook" className="w-6 h-6" />
        </a>
        <a href="https://www.instagram.com/daquv_corp/" target="_blank" rel="noopener noreferrer">
          <img src="/icons/instagram.png" alt="Instagram" className="w-6 h-6" />
        </a>
        <a href="https://blog.naver.com/askavatar" target="_blank" rel="noopener noreferrer">
          <img src="/icons/blog.png" alt="Blog" className="w-6 h-6" />
        </a>
        <a href="https://www.youtube.com/channel/UCxZzQUdbwkFQoIX3tpSsk-g" target="_blank" rel="noopener noreferrer">
